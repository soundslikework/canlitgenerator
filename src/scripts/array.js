var options = [
				[
					[ //SINGLE PROTAGONIST
						...
						// "Gordie Howe",
						"Paul Gross",
						"A biplane pilot returning from war",
						"An old woman",
						"An unusually tall municipal bureaucrat",
						"An old man",
						"The ghost of Thomas D'Arcy McGee",
						"A weeping logger",
						"A Vancouver software engineer",
						"A possibly-unintentional stand-in for the author"
					], [//SINGLE ACTION
						...
						" stands at the sink of their simple cabin",
						" moves into an apartment Leonard Cohen once lived in",
						" wins a ticket to the Vinyl Cafe",
						" learns the tragic difference between Steelhead and Rainbow trout",
						" starts a craft brewery",
						" is forced to confront a terrible truth",
						" pursues a cold case murder",
						" treks across the prairie",
						" joins the Social Credit Party",
						" unravels a web of deceit",
						" finds the exact center of a stand of birch trees",
						" researches the War Measures Act",
						" digs a tunnel",
						" slowly discovers the charms of small-town life",
						" discovers the bittersweet pain of remembrance",
						" plans a trip to Dawson City"
					], [ //SINGLE REASON
						...
						" while helplessly watching as the harvest fails.",
						" to avoid the Draft.",
					...
					[	//PLURAL PROTAGONIST
						...
						"A young couple",
						"Tree planters",
						"A team of Waterloo web developers"
					], [//PLURAL ACTION
						...
						" move into an apartment Leonard Cohen once live in",
						" win tickets to the Vinyl Cafe",
						" pursues a cold case murder.",
						" are forced to confront terrible truths",
						" trek across the prairie",
						" find success growing hydrangeas",
						" join the Social Credit Party",
						" unravel a web of deceit",
						" find the exact center of a stand of birch trees",
						" dig a tunnel",
						" slowly discover the charms of small-town life",
						" discover the bittersweet pain of remembrance",
						" plan a trip to Dawson City"
					], [ //PLURAL RESULT
						" to learn the darkest secrets of their family.",
						", but only after multiple scenes of ice skating.",
						", disillusioned with the pace and emptiness of urban living.",
						...
						". To each other, they say nothing.",
						", realizing too late that the long harsh winter is a metaphor for their relationship.",
						" and their relationship evolves and changes, kind of like the seasons, yeah?",
						// " but only after Diefenbaker says they can.",
						" hoping to finally and for good reunite Alexisonfire.",
						" for many years.",
						", after being blinded by smoke from a wildfire.",
						" because it's 2016.",
